  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        // Headings (Booster Sans Variable)
        'heading-xxxs':    ['18px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-xxs':     ['20px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-xs':      ['24px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-s':       ['28px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-m':       ['32px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-l':       ['40px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-xl':      ['48px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-xxl':     ['56px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-xxxl':    ['64px',  { lineHeight: '1.1', fontWeight: '500' }],
        'heading-display': ['80px',  { lineHeight: '1.1', fontWeight: '500' }],
        'display-x':       ['88px',  { lineHeight: '1',   fontWeight: '500' }],
        'display-xx':      ['96px',  { lineHeight: '1',   fontWeight: '500' }],
        'display-xxx':     ['120px', { lineHeight: '1',   fontWeight: '500' }],
        'display-xxxl':    ['144px', { lineHeight: '1',   fontWeight: '500' }],
        // Mono (PP Supply Mono)
      ...
      boxShadow: {
        ...
        'btn-inner': 'inset 0px 6px 16px 0px rgba(255,255,255,0.10), inset 0px 2px 2px 0px rgba(255,255,255,0.05), inset 0px -2px 2px 0px rgba(0,0,0,0.05)',
      },
