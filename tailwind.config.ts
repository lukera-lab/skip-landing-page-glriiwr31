  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        // Headings (Booster Sans Variable — weight: 600, width axis: 90)
        'heading-xxxs': ['18px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-xxs': ['20px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-xs': ['24px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-s': ['28px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-m': ['32px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-l': ['40px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-xl': ['48px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-xxl': ['56px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-xxxl': ['64px', { lineHeight: '1.1', fontWeight: '600' }],
        'heading-display': ['80px', { lineHeight: '1.1', fontWeight: '600' }],
